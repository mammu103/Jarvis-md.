...
module.exports = {
  AUDIO_DATA: process.env.AUDIO_DATA || '𝛭𝑈𝛨𝛥𝛭𝛭𝛯𝐷;ᴄᴀᴛ ꜱᴩʏ;https://kommodo.ai/i/qf1aLxlX3lMhU3Q73jbj',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'ᴄᴀᴛ ꜱᴩʏ;ᴡᴀʙᴏᴛ',
  AUTO_STATUS_VIEWS: toBool(process.env.AUTO_STATUS_VIEWS || 'false'),
  WELCOME_MSG: process.env.WELCOME_MSG || 'Hi @user Welcome to @gname',
  GOODBYE_MSG: process.env.GOODBYE_MSG || 'Hi @user It was Nice Seeing you',
  AUTHOR: process.env.AUTHOR || 'ʟᴏᴋɪ-xᴇʀ',
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;ᴄᴀᴛ ꜱᴩʏ;https://kommodo.ai/i/qf1aLxlX3lMhU3Q73jbj',
  SUDO: process.env.SUDO || '917025673121,',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'ᴄᴀᴛ ꜱᴩʏ;𝛭𝑈𝛨𝛥𝛭𝛭𝛯𝐷;https://kommodo.ai/i/qf1aLxlX3lMhU3Q73jbj',
